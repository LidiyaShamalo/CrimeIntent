...
class CrimeFragment : Fragment(), DatePickerFragment.Callbacks {
            ...
            Observer { crime ->
                crime?.let {
                    ...
                    photoUri = FileProvider.getUriForFile(requireActivity(),
                        "com.arkteya.criminal_intent.fileprovider",
                        photoFile)
                    updateUI()
                }
            })
    ...
    override fun onStart() {
        ...
        suspectButton.apply {
            val pickContactIntent = Intent(ACTION_PICK, ContactsContract.Contacts.CONTENT_URI)
            setOnClickListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
      //  Log.d("MyApp", "onActivityResult called with requestCode: $requestCode and resultCode: $resultCode")
        when {
